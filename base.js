...
const CLOUD_CONFIG = {
    ...
    RAW_DATA_URL: 'https://gist.githubusercontent.com/ebaizs/097f8adbb3790f3a95ba586a0867699b/raw/your-data.json',
    RAW_USER_URL: 'https://gist.githubusercontent.com/ebaizs/097f8adbb3790f3a95ba586a0867699b/raw/zhanghao.js',
    
    // 文件命名约定（不要修改）
    DATA_FILES: {
        CLOUD_JSON: 'my-data.json',   
        CLOUD_JSON: 'your-data.json',     // 工地数据文件
