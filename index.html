    ...
    <div class="container hidden" id="mainContainer">
        ...
        <div class="header">
            <div class="header-left">
                <h1>立诺装饰项目管理系统</h1>
                <span>清扬 15662061321</span>
            </div>
  <!-- 在 index.html 的顶部按钮部分，确保配置管理按钮存在 -->
<div class="header-top-buttons">
    <!-- 单一云端备份按钮 -->
    <button class="top-btn btn-success" onclick="saveToGitHub()" title="备份完整数据到云端（包含图片）">
        备份至云端
    </button>
    
    <!-- 云端加载按钮 -->
    <button class="top-btn btn-warning" onclick="loadFromGitHub()" title="从云端加载数据（合并）">
        从云端加载
    </button>
    
    <!-- 本地备份按钮 -->
    <button class="top-btn btn-danger" onclick="saveToJsFile()" title="备份完整数据到本地ZIP文件">
        备份完整数据
    </button>
    
    <!-- 本地加载按钮 -->
    <button class="top-btn btn-info" onclick="loadFromJsFile()" title="从ZIP文件加载数据（覆盖）">
        从文件加载
    </button>
    ...
    <!-- 权限管理（仅管理员可见） -->
    <button class="top-btn btn-danger permission-manager-btn" onclick="showPermissionManager()" title="权限管理">
        权限管理
    </button>
    
    <!-- 更改日志（仅管理员可见） -->
    <button class="top-btn btn-primary change-log-btn" onclick="showChangeLog()">更改日志</button>
</div>
        <!-- 主内容区 -->
                ...
                <div class="tab-content-wrapper">
                    ...
                    <div class="tab-content" id="todoTab">
                        ...
                        <div class="form-row" style="flex-wrap: wrap;">
                            ...
                            <div class="form-group" style="flex: 0 0 100%; margin-top: 15px;">
                                ...
                                <input type="text" id="todoNote" maxlength="20" class="input-note" placeholder="20字符以内备注说明">
                            </div>
                        </div>
                   ...
                   <div class="tab-content" id="expenseTab">
                    ...
                    <div class="tab-content" id="requirementTab">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="requirementContent" maxlength="15" class="input-content" placeholder="15字符以下要求内容">
                            </div>
                            <div class="form-group">
                                <label>要求类型</label>
                        ...
                        <div class="form-row">
                            <div class="form-group" style="flex: 0 0 100%;">
                                ...
                                <input type="text" id="requirementNote" maxlength="20" class="input-note" placeholder="20字符以下备注说明">
                            </div>
                        </div>
                    ...
                    <div class="tab-content" id="repairTab">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="repairContent" maxlength="10" class="input-content" placeholder="10字符以下维修内容">
                            </div>
                            <div class="form-group">
                                <label>备注说明（20字符以下）</label>
                                <input type="text" id="repairNote" maxlength="20" class="input-note" placeholder="20字符以下备注说明">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>上传照片</label>
                    ...
                    <div class="tab-content" id="workerTab">
                        ...
                        <div class="form-group">
                            <label>备注说明（20字符以下）</label>
                            <input type="text" id="workerNote" maxlength="20" class="input-note" placeholder="20字符以下备注说明">
                        </div>
                    ...
                    <div class="tab-content" id="addRemoveTab">
                        ...
                        <div class="form-group">
                            <label>备注说明（20字符以下）</label>
                            <input type="text" id="addRemoveNote" maxlength="20" class="input-note" placeholder="20字符以下备注说明">
                        </div>
                    ...
                    <div class="tab-content" id="drawingTab">
                        ...
                        <div class="form-group">
                            <label>备注说明（20字符以下）</label>
                            <input type="text" id="drawingNote" maxlength="20" class="input-note" placeholder="20字符以下备注说明">
                        </div>
                    ...
                    <div class="tab-content" id="experienceTab">
                        ...
                        <div class="form-group">
                            <label>经验总结内容</label>
                            <textarea id="experienceContent" rows="3" class="input-note" placeholder="请输入项目经验总结..."></textarea>
                        </div>
...
<script>
// 只在HTML中添加这个简单的检查，其他变量在各自的JS文件中定义
console.log('开始加载脚本...');
</script>

<script src="quanxian.js"></script>  <!-- 先加载权限文件 -->
<script src="yun.js"></script>      <!-- 再加载云功能文件 -->
<script src="app.js"></script>      <!-- 最后加载主逻辑文件 -->
</html>
